...
"""
    ...
    installer.verifyActions([
        {'tool':'portal_discussion',
         ...
         'condition': "python:getattr(object.getTypeInfo(),'cps_proxy_type','') in ('document', 'folderishdocument') and getattr(object.getContent(), 'allow_discussion', None) == 0",
        ...
        {'tool':'portal_discussion',
         ...
         'action': "string:${object/absolute_url}/manage_comments",
         'condition': "python:getattr(object.getTypeInfo(),'cps_proxy_type','') in ('document', 'folderishdocument') and getattr(object.getContent(), 'allow_discussion', None) == 1",
         'permission': 'Forum manage comments',
         'category': 'object',},
        {'tool':'portal_discussion',
