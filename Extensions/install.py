...
def install(self):
    ...
    portal['portal_discussion'].addAction(
        ...
        condition="python:object is not None and object.portal_type != 'CPSForum' and portal.portal_discussion.isCommentingAllowedFor(object)",
        permission='View',
        category='object')
    ...
    p_actions.addAction(
        ...
        condition="python:getattr(object, 'portal_type', None) not in ('Section', 'Workspace', 'Portal', 'Calendar', 'Event', 'CPSForum')",
        permission='View',
        category='workflow')
